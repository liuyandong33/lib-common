...
public class AddSkuModel extends JDDJBasicModel {
    /**
     * 请求唯一编码
     */
    @NotNull
    ...
    public static class Builder extends JDDJBasicModel.Builder<Builder, AddSkuModel> {
        ...
        @Override
        public AddSkuModel build() {
            AddSkuModel addSkuModel = super.build();
            addSkuModel.setTraceId(instance.getTraceId());
            addSkuModel.setOutSkuId(instance.getOutSkuId());
            addSkuModel.setShopCategories(instance.getShopCategories());
            addSkuModel.setCategoryId(instance.getCategoryId());
            addSkuModel.setBrandId(instance.getBrandId());
            addSkuModel.setSkuName(instance.getSkuName());
            addSkuModel.setSkuPrice(instance.getSkuPrice());
            addSkuModel.setWeight(instance.getWeight());
            addSkuModel.setUpc(instance.getUpc());
            addSkuModel.setImages(instance.getImages());
            addSkuModel.setProductDesc(instance.getProductDesc());
            addSkuModel.setIfViewDesc(instance.getIfViewDesc());
            addSkuModel.setSlogan(instance.getSlogan());
            addSkuModel.setSloganStartTime(instance.getSloganStartTime());
            addSkuModel.setSloganEndTime(instance.getSloganEndTime());
            addSkuModel.setPrefixKeyId(instance.getPrefixKeyId());
            addSkuModel.setPrefixKey(instance.getPrefixKey());
            addSkuModel.setPreKeyStartTime(instance.getPreKeyStartTime());
            addSkuModel.setPreKeyEndTime(instance.getPreKeyEndTime());
            addSkuModel.setLength(instance.getLength());
            addSkuModel.setWidth(instance.getWidth());
            addSkuModel.setHeight(instance.getHeight());
            addSkuModel.setTransportAttribute(instance.getTransportAttribute());
            addSkuModel.setLiquidStatue(instance.getLiquidStatue());
            addSkuModel.setPrescripition(instance.getPrescripition());
            addSkuModel.setFixedStatus(instance.getFixedStatus());
            addSkuModel.setIsSale(instance.getIsSale());
            addSkuModel.setSellCities(instance.getSellCities());
            return addSkuModel;
        }
    }
