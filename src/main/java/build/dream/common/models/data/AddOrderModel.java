...
public class AddOrderModel extends DadaBasicModel {
    /**
    ...
    public static class Builder extends DadaBasicModel.Builder<Builder, AddOrderModel> {
        ...
        @Override
        public AddOrderModel build() {
            AddOrderModel addOrderModel = super.build();
            addOrderModel.setShopNo(instance.getShopNo());
            addOrderModel.setOriginId(instance.getOriginId());
            addOrderModel.setCityCode(instance.getCityCode());
            addOrderModel.setCargoPrice(instance.getCargoPrice());
            addOrderModel.setIsPrepay(instance.getIsPrepay());
            addOrderModel.setReceiverName(instance.getReceiverName());
            addOrderModel.setReceiverAddress(instance.getReceiverAddress());
            ...
            addOrderModel.setInfo(instance.getInfo());
            addOrderModel.setCargoType(instance.getCargoType());
            addOrderModel.setCargoWeight(instance.getCargoWeight());
            addOrderModel.setCargoNum(instance.getCargoNum());
            addOrderModel.setInvoiceTitle(instance.getInvoiceTitle());
            addOrderModel.setOriginMark(instance.getOriginMark());
            addOrderModel.setOriginMarkNo(instance.getOriginMarkNo());
            addOrderModel.setIsUseInsurance(instance.getIsUseInsurance());
            addOrderModel.setIsFinishCodeNeeded(instance.getIsFinishCodeNeeded());
            addOrderModel.setDelayPublishTime(instance.getDelayPublishTime());
            addOrderModel.setIsDirectDelivery(instance.getIsDirectDelivery());
