...
public class BindAxbModel extends BasicModel {
    /**
    ...
    public static class Builder {
        private final BindAxbModel instance = new BindAxbModel();
        ...
        public BindAxbModel build() {
            BindAxbModel bindAxbModel = new BindAxbModel();
            bindAxbModel.setExpiration(instance.getExpiration());
            bindAxbModel.setPhoneNoA(instance.getPhoneNoA());
            bindAxbModel.setPhoneNoB(instance.getPhoneNoB());
            bindAxbModel.setPoolKey(instance.getPoolKey());
            bindAxbModel.setExpectCity(instance.getExpectCity());
            bindAxbModel.setIsRecordingEnabled(instance.getIsRecordingEnabled());
            bindAxbModel.setOutId(instance.getOutId());
            bindAxbModel.setOutOrderId(instance.getOutOrderId());
            bindAxbModel.setPhoneNoX(instance.getPhoneNoX());
            return bindAxbModel;
        }
    }
