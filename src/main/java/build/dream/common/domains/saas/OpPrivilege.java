...
public class OpPrivilege extends BasicDomain {
    public static final String TABLE_NAME = "op_privilege";
    /**
     * 权限编号
     */
    ...
    public static class Builder extends BasicDomain.Builder<Builder, OpPrivilege> {
        ...
        @Override
        public OpPrivilege build() {
            OpPrivilege backgroundPrivilege = super.build();
