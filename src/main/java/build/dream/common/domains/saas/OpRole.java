...
public class OpRole extends BasicDomain {
    public static final String TABLE_NAME = "op_role";
    /**
     * 商户ID
     */
    ...
    public static class Builder extends BasicDomain.Builder<Builder, OpRole> {
