...
public class ConnectionOptionWrapper {
     ...
     */
    public ConnectionOptionWrapper(String instanceId, String accessKey, String clientId, Map<String, String> tokenData) {
    ...
    public ConnectionOptionWrapper(String instanceId, String accessKey, String secretKey, String clientId) {
        ...
        mqttConnectOptions.setPassword(Base64.encodeBase64String(HmacUtils.hmacSha1(secretKey, clientId)).toCharArray());
        mqttConnectOptions.setCleanSession(true);
        mqttConnectOptions.setKeepAliveInterval(90);
        mqttConnectOptions.setAutomaticReconnect(true);
        mqttConnectOptions.setMqttVersion(MQTT_VERSION_3_1_1);
