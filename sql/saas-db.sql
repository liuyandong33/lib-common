...
(
    ...
    dada_source_id BIGINT NOT NULL COMMENT '达达商户ID',
    jddj_vender_id VARCHAR(20) NOT NULL COMMENT '京东到家商家ID',
    jddj_app_key VARCHAR(50) NOT NULL COMMENT '京东到家授权应用app key',
    jddj_app_secret VARCHAR(50) NOT NULL COMMENT '京东到家授权应用app secret',
...
(
    ...
    alipay_public_key VARCHAR(500) NOT NULL COMMENT '支付宝公钥',
    alipay_sign_type VARCHAR(20) NOT NULL COMMENT '支付宝签名方式',
    notify_result TINYINT NOT NULL COMMENT '回调结果，1-未回调 2-回调成功，3-回调失败',
    wei_xin_pay_api_key VARCHAR(50) NOT NULL COMMENT '微信支付api 秘钥',
    wei_xin_pay_sign_type VARCHAR(20) NOT NULL COMMENT '微信支付签名方式',
    wei_xin_pay_api_v3_key VARCHAR(50) NOT NULL COMMENT '微信支付退款api_v3 秘钥',
...
DROP TABLE IF EXISTS jddj_token;
CREATE TABLE jddj_token
(
    id BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT 'id',
    token VARCHAR(50) NOT NULL COMMENT 'token',
...
DROP TABLE IF EXISTS jddj_code;
CREATE TABLE jddj_code
(
    id BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT 'id',
